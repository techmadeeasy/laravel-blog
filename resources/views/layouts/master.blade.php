            ...
            <div class="sidebar-content">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-badge"></i><span class="sidebar-mini-hide">Menu</span></a>
                            <ul>
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href=""><span class="sidebar-mini-hide">Users</span></a>
                                    <ul>
                                        <li>
                                            <a href="{{ route('users.create') }}"><span class="sidebar-mini-hide">New User</span></a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><span class="sidebar-mini-hide">Media</span></a>
                                    <ul>
                                        <li>
                                            <a href="{{ route('media.index') }}">Images</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('media.create') }}">Upload</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
